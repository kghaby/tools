...
#SBATCH --job-name=3.6US${i}l # Name to show in the job queue 
...
pmemd.cuda -O -i US_$i.mdin -o US_$i.1.mdout -p $parm -c ${rst_dir}/US_$i/US_$i.5.rst7 -r US_$i.1.rst7 -x US_$i.1.nc -inf US_$i.1.mdinfo
