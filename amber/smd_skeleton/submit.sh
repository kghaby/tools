...
#SLURM params are computer-dependent
##CHANGE: distance masks, harm, cv_ni, cv_i, 
name="test"
	#for 3 job names
harm="5.0"
...
distance @1276,2344 @4332  out dist_prod.dat
EOF
...
#SBATCH --mail-user=kyleghaby@uchicago.edu # Who to send emails to
#SBATCH --mail-type=ALL # Send emails on start, end and failure
#SBATCH --job-name=postprocess.$name
#SBATCH --time=2:00:00
