...
#whitelist=("EGFR_AB" "EGFR_IB" "SRC_DGY" "BTK1_IB" "MKK7_IB" "BTK_4A9" "BTK_4B9" "BTK_4C9" "EGFR_4C9" "SRC_5YZ" "AURKA_5YZ")
#whitelist=("BTK_4A9" "BTK_4B9" "BTK_4C9")
whitelist=("AURKA_5YZ" "SRC_5YZ")
blacklist=()
