...
parm_l="../../linked/prep/${KIN_LIG}_l_alt.parm7"
parm_u="../../unlinked/prep/${KIN_LIG}_u_alt.parm7"
...
#    set ytics 0, 1, $yticmax1
	...
	plot \
    "${fl1[0]}"   u (0.04 * column(1)):2 every 10 w l lw 2 lc rgb "slateblue1" title "L",\
    "${fl1[1]}"   u (0.04 * column(1)):2 every 10 w l lw 2 lc rgb "dark-orange" title "U"
 ...
 #   set ytics 0, 1, $yticmax2
    ...
    plot \
    "${fl2[0]}"   u (1 * column(1)):2 every 1 w l lw 2 lc rgb "slateblue1" title "L",\
    "${fl2[1]}"   u (1 * column(1)):2 every 1 w l lw 2 lc rgb "dark-orange" title "U"
#    pause -1
