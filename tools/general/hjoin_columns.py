...
def combine_data(file1, file2, output_file, log_file, col1_idx, col2_idx):
    df1 = pd.read_csv(file1, delim_whitespace=True, comment='#')
    df2 = pd.read_csv(file2, delim_whitespace=True, comment='#')
...
def main():
    ...
    p.add_argument("-o", default="aligned_data.dat", help="Output file name")
    p.add_argument("-l", default="align.log", help="Log file name")
